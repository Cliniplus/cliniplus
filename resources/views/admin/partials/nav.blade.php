<div class="header">
  ...
  <ul class="nav user-menu">
    ...
    <li class="nav-item dropdown has-arrow">
      <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
        <span class="user-img"><img class="rounded-circle" src="{{config('constants.img_url').Session()->get('user')['image']}}" width="31" alt="{{Session()->get('user')['fullName']}}"></span>
      </a>
      <div class="dropdown-menu">
        <div class="user-header">
          <div class="avatar avatar-sm">
            <img src="{{config('constants.img_url').Session()->get('user')['image']}}" alt="User Image" class="avatar-img rounded-circle">
          </div>
          <div class="user-text">
            <h6>{{Session()->get('user')['fullName']}}</h6>
            <p class="text-muted mb-0">Administrator</p>
          </div>
        </div>
        <a class="dropdown-item" href="{{route('getProfile')}}">My Profile</a>
        <a class="dropdown-item" href="{{route('getSettings')}}">Settings</a>

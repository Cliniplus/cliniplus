                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-4">
                            <div class="dash-widget dct-border-rht">
                                ...
                                <div class="dash-widget-info">
                                    <h6>Total Patient</h6>
                                    <h3> @if(!is_null($patients)) {{count($patients)}} @else 0 @endif
                                    </h3>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="dash-widget">
                                ...
                                <div class="dash-widget-info">
                                    <h6>Appoinments</h6>
                                    <h3>@if(!is_null($patientAppointments)) {{count($patientAppointments)}} @else 0 @endif</h3>
                    ...
                    <div class="card card-table mb-0">
                        <div class="card-body">
                            <div class="appointments">
                                @if(!is_null($patientAppointments)) 
